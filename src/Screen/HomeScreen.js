  ...
  categories: [
    {
      name: 'Women',
      featured: [
        { name: 'Sleep', href: '/product' },
        { name: 'Swimwear', href: '/product' },
        { name: 'Underwear', href: '/product' },
      ],
      collection: [
        { name: 'Everything', href: '/product' },
        { name: 'Core', href: '/product' },
        { name: 'New Arrivals', href: '/product' },
        { name: 'Sale', href: '/product' },
      ],
      categories: [
        { name: 'Basic Tees', href: '/product' },
        { name: 'Artwork Tees', href: '/product' },
        { name: 'Bottoms', href: '/product' },
        { name: 'Underwear', href: '/product' },
    ...
    },
    {
      name: 'Men',
      featured: [
        { name: 'Casual', href: '/product' },
        { name: 'Boxers', href: '/product' },
        { name: 'Outdoor', href: '/product' },
      ],
      collection: [
        { name: 'Everything', href: '/product' },
        { name: 'Core', href: '/product' },
...
const footerNavigation = {
  ...
  customerService: [
    { name: 'Contact', href: '/col' },
    { name: 'Shipping', href: '/col' },
    { name: 'Returns', href: '/col' },
    { name: 'Warranty', href: '/col' },
    { name: 'Secure Payments', href: '/col' },
    { name: 'FAQ', href: '/col' },
    { name: 'Find a store', href: '/col' },
  ],
  company: [
    { name: 'Who we are', href: '/col' },
    { name: 'Sustainability', href: '/col' },
    { name: 'Press', href: '/col' },
    { name: 'Careers', href: '/col' },
    { name: 'Terms & Conditions', href: '/col' },
    { name: 'Privacy', href: '/col' },
  ],
  legal: [
    { name: 'Terms of Service', href: '/col' },
    { name: 'Return Policy', href: '/col' },
    { name: 'Privacy Policy', href: '/col' },
    { name: 'Shipping Policy', href: '/col' },
  ],
  bottomLinks: [
    { name: 'Accessibility', href: '/col' },
    { name: 'Privacy', href: '/col' },
    { name: 'Terms', href: '/col' },
  ],
}
        ...
        <section aria-labelledby="trending-heading" className="bg-white">
          <div className="py-16 sm:py-24 lg:mx-auto lg:max-w-7xl lg:py-32 lg:px-8">
            <div className="flex items-center justify-between px-4 sm:px-6 lg:px-0">
              ...
              <a href="/col" className="hidden text-sm font-semibold text-indigo-600 hover:text-indigo-500 sm:block">
                See everything
